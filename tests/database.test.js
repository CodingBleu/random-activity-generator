...
describe('Database Operations', () => {
  ...
  test('should create a new SQLite database instance', () => {
    ...
    expect(sqlite3.Database).toHaveBeenCalledWith('activities.db', expect.any(Function));
  });
  ...
  test('getRandomCategory should return a valid category', async () => {
    ...
    const expectedCategories = ['Sport', 'Culture', 'Education', 'Information', 'Culinary', 'Housework'];
